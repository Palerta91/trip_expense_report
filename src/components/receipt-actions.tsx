...
import { LoaderCircle, Pencil, Replace, Trash2 } from "lucide-react";

export function ReceiptActions({ receiptId, tripId, editHref }: { receiptId: string; tripId: string; editHref?: string }) {
